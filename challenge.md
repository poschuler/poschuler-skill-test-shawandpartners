...
- Debes enviar tu solución como un **repositorio PRIVADO en GitHub** e invitar a **xxxxxxx@xxxxxx.com** como colaborador. También puedes intentarlo con el nombre de usuario **xxx-tests**.
...
- Entender los requisitos también es parte de la prueba. Para cualquier otro problema, comunícate con **xx@xxxxxxxxx.com** para obtener ayuda.
